...
## 概要
AWS Clean Rooms MLは、複数企業が生データ（PII）を互いに共有・移動することなく、
安全に共同で機械学習モデルをトレーニング・推論できるサービス。

---

## 一言で

AWS Clean Rooms ML = データを見せずに共同でMLできる仕組み
